...
export function ActiveMatchCard() {
  const { request, condition, proposal, cancel, stream } = useMatch();
  ...
  return <section className="home-active-match" aria-labelledby="active-match-heading">
    <div className="section-head"><h2 id="active-match-heading">현재 매칭</h2></div>
    <div className="home-current match-live-card">
